        ...
        <section className="py-20 bg-gradient-hero text-primary-foreground">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl opacity-90 max-w-3xl mx-auto leading-relaxed">
              Ready to discuss your foundry equipment needs? Our expert team is here to provide customized solutions and technical support.
            </p>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
              {contactInfo.map((info, index) => (
                <Card key={index} className="professional-card hover-lift cursor-pointer">
            ...
            <div className="grid lg:grid-cols-2 gap-12">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-muted-foreground text-lg">
                    Visit our facilities or contact our regional offices for personalized support.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <Button variant="outline" className="btn-outline-primary h-16 flex-col">
        ...
        <section className="py-20 bg-muted/30">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-muted-foreground">Quick answers to common inquiries</p>
            </div>
              ...
              {[
                {
                  ...
                  answer: "Standard equipment delivery is 8-12 weeks. Custom solutions may require 12-16 weeks depending on specifications."
                },
                {
                  question: "Do you provide installation and training?",
                  answer: "Yes, we provide complete installation services and comprehensive operator training at your facility."
                },
                {
                  question: "What warranty do you offer?",
                  answer: "We offer 12-month comprehensive warranty with optional extended warranty plans available."
                },
                {
                  question: "Do you have international support?",
                  answer: "Yes, we have service partners in 50+ countries and provide 24/7 remote technical support."
                }
              ].map((faq, index) => (
                <Card key={index} className="professional-card">
                  <CardContent className="p-6">
